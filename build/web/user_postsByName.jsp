...
<%
    ...
    int otherUserId = Integer.parseInt(request.getParameter("author_id"));
    UserDao userDao = new UserDao(ConnectionProvider.getConnection());
    User otherUser = userDao.getUserByUserId(otherUserId);
    System.out.println("From user_postsByName otherUserName "+otherUser.getName());
    ...
    <body>
        ...
        <script>
            ...
            function getPosts(catId, clink) {
                ...
                $.ajax({
                    url: "load_otherUser_posts.jsp?author_id=<%= otherUserId%>",
                    data: {cid: catId},
                    success: function (data, textStatus, jqXHR) {
                        console.log(data);
                        $("#loader").hide();
