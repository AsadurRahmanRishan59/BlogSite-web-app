                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="list-group">
                            <a href="#" onclick="getPosts(0,<%= otherUser.getId()%>, this)" class="c-link list-group-item list-group-item-action ">
                                All Post
                            </a>
                            <!--categories-->
                            <%
                            ...
                            <a href="#" onclick="getPosts(<%= category.getCid()%>,<%= otherUser.getId()%>, this)" class="c-link list-group-item list-group-item-action">
                                <%= category.getName()%>
                            </a>
